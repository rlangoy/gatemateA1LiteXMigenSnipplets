...
from mycsrlib.crc32peripheral import CRC32Peripheral, GhdlCologneChipToolchain
import argparse
...
class MySoC(BaseSoC):
    def __init__(self, **kwargs):
        ...
        # Instantiate peripheral
        self.submodules.crc32_peripheral = CRC32Peripheral(platform)

        # Register as CSR
        self.add_csr("crc32_peripheral")
...
def main():
    ...
    soc.platform.toolchain = GhdlCologneChipToolchain()                   # to add VHDL support 
